...
function mapRowToShow(row, index) {
  ...
  return {
    ...
    hotelRate: parseFloat(normalizedRow.hotelRate) || 0,
    hotelRooms: parseInt(normalizedRow.hotelRooms) || 0,
    hotelNights: parseInt(normalizedRow.hotelNights) || 0,
